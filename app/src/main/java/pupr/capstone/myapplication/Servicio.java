...
public class Servicio {
    ...
    /**
     * Genera código hash basado en tipo, fecha y tablilla
     */
    @Override
    public int hashCode() {
        int result = tipoServicio != null ? tipoServicio.hashCode() : 0;
        result = 31 * result + (fechaServicio != null ? fechaServicio.hashCode() : 0);
        result = 31 * result + (tablillaVehiculo != null ? tablillaVehiculo.hashCode() : 0);
        return result;
    }
}