...
/**
 * Clase CalendarPicker - Componente de selección de fechas con soporte para
 * fecha única o rango de fechas
 *
 * Esta clase maneja la lógica de un calendario interactivo que permite:
 * - Seleccionar una fecha única
 * - Seleccionar un rango de fechas (inicio y fin)
 * - Navegar entre meses y años
 * - Asociar fechas con información de vehículos
...
public class CalendarPicker {
    ...
    // ATRIBUTOS DE CONTEXTO (OPCIONAL)


    /** Información del vehículo asociado (opcional) */
    private String vehiculoInfo;

    /** Tablilla del vehículo asociado (opcional) */
     ...
     * @return String en formato "Mes Año" (ej: "Enero 2025")
     */
